...
const Complaints = () => {
  ...
  const fetchComplaints = async () => {
    try {
      const response = await fetch('https://api.merabestie.com/complaints/get-complaints');
  ...
  const handleStatusChange = async (complaintId, newStatus) => {
    try {
      const response = await fetch('https://api.merabestie.com/update-complaint-status', {
        method: 'PUT',
        headers: {
