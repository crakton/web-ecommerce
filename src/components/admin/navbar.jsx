            ...
            <div className="bg-pink-100 flex items-center justify-between p-4">
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="hidden md:flex space-x-6">
                        <a href="/new" className="text-blue-500 hover:bg-primary px-3 py-2 rounded-full">NEW</a>
                        <a href="/dresses" className="text-blue-500 hover:bg-primary px-3 py-2 rounded-full">DRESSES</a>
                        <a href="/clothing" className="text-blue-500 hover:bg-primary px-3 py-2 rounded-full">CLOTHING</a>
                        <a href="/accessories" className="text-blue-500 hover:bg-primary px-3 py-2 rounded-full">ACCESSORIES</a>
                        <a href="/sale" className="text-blue-500 hover:bg-primary px-3 py-2 rounded-full">SALE</a>
                    </div>
                </div>
